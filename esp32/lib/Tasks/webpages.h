const char _otaFirmwareIndexHtml[] PROGMEM = R"rawliteral(
...
/** This is generated by vuejs (which exception of the a.bin because it doesn't havve a js extension)
 * !! ENSURE THIS IS CURRENT WITH WHAT vuejs is generating.
 */
const char _rootIndexHtml[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html lang='en'>
  <head>
    <meta charset='utf-8'>
    ...
    <link rel='icon' href='b.bin'>
    <title>Speed Master</title>
    <link href='/a.bin' rel='preload' as='script'>
  </head>
  <body>
    <noscript>
      <strong>We're sorry but growweb doesn't work properly without JavaScript enabled. Please enable it to continue.</strong>
    </noscript>
    <div id='app'></div>
    <script type='text/javascript' src='/a.bin'></script>
  </body>
</html>
)rawliteral";

const char _otaSpiffsIndexHtml[] PROGMEM = R"rawliteral(
<!DOCTYPE HTML>
<html lang="en">
<head>
